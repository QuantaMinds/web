...
const ChatBot: React.FC = () => {
  ...
  const sendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let message = "I'm having trouble connecting right now. Please try again later.";
  ...
  const scheduleMeeting = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { text: "Couldn't schedule your meeting. Please try again later.", sender: 'bot' },
      ]);
    } finally {
      setIsLoading(false);
    }
        ...
        <Card className="w-80 md:w-96 shadow-xl flex flex-col h-96 border border-quantminds-purple/30 animate-scale-in">
          ...
          <div className="p-4 border-t">
            ...
            <div className="mt-3 text-center">
              <button onClick={scheduleMeeting} className="text-xs text-quantminds-purple hover:underline" disabled={isLoading}>
